...
-- record
ALTER TABLE `record` ADD INDEX idx1(`status`, `updated_at` desc, `record_id` asc);
ALTER TABLE `record` ADD INDEX idx2(`created_by`, `status`, `updated_at` desc, `record_id` asc);
